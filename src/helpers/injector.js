...
const iframeStyles = () => 'position: fixed;top: 0;width: 410px;padding:5px;height: 110px;left: 50%;transform: translate(-50%);background-color:#f0f5ea;box-shadow:0 0 1px rgba(94,164,0,.9);font-size:13px;border:1px solid #EFEFEF;display: none';
