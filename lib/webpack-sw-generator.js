...
var generateStaticAssetsFetchHandler = function generateStaticAssetsFetchHandler(staticRouting, cacheFirstCacheName) {
    ...
    _createClass(ServiceWorkerGenerator, [{
        ...
        value: function apply(compiler) {
            ...
            var uglify = options.uglify,
                ...
                hooks = _options$hooks === undefined ? {} : _options$hooks;
